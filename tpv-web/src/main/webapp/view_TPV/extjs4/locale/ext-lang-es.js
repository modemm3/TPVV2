...
if(Ext.form.NumberField){
  Ext.apply(Ext.form.NumberField.prototype, {
    decimalSeparator : ".",
    decimalPrecision : 2,
    minText : "El valor mánimo para este campo es de {0}",
    maxText : "El valor míximo para este campo es de {0}",
...
if(Ext.form.DateField){
  Ext.apply(Ext.form.DateField.prototype, {
    ...
    invalidText       : "{0} no es una fecha válida - debe tener el formato dd/mm/aaaa",
    format            : "d/m/Y",
